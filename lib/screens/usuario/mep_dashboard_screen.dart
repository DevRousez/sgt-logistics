...
class MepDashboardScreen extends StatefulWidget {
  const MepDashboardScreen({super.key});

  @override
  State<MepDashboardScreen> createState() => _MepDashboardScreenState();
}
    ...
    if (data != null && data["user"] != null) {
      ...
      setState(() {
        ...
        if (clienteNombre != null && clienteNombre.isNotEmpty) {
          _empresaNombre = clienteNombre;
        } else {
          _empresaNombre = "MEP - Empresa Asignada";
        }
      });
    }
  }
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Column(
            ...
            children: [
              const Text("MEP - Panel", style: TextStyle(fontSize: 16)),
              Text(
                _empresaNombre,
