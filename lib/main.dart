...
import 'screens/operador/operador_dashboard_screen.dart';
...
class SGTApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (ApiService.token != null && ApiService.token!.isNotEmpty) {
      if (ApiService.sessionType == 'usuario') {
        initialScreen = const UsuarioDashboardScreen();
      } else if (ApiService.sessionType == 'operador') {
        initialScreen = const OperadorDashboardScreen();
      }
    }
